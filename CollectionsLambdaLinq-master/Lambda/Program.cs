...
namespace Lambda
{
    class Program
    {
        ...
        private static void AnonymousFunctExample()
        {
            ...
            //Omitting the explicit creation of a Func instance
            Console.Write($"{val1} + {val2} = ");
            SpecialFunctions.ExecuteFunctionUsingFunc(delegate (double var1, double var2)
            {
                return var1 + var2;
            },
                                                      val1,
        ...
        private static void LambdaExample()
        {
            ...
            Func<double,double,double> max = (p, q) =>
            {
                
                 if (p > q) return p;
                    else return q;
            };
            //double max_result = max(1, 4);
            ...
            //var result = PerformCalculation(max, numbersList);
